...
Link the components to form a topology.
     ...
     t.link("L0", nil, "C1", 0.7)  # L0 is starting the point for invoking C1 
...
This uses the graphviz library in order to generate a picture of the topology. The filetypes (e.g. :png) correspond to the file types provided by graphviz. 
